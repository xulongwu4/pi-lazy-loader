...
**Release commit:** `pending` (working tree v0.3.1)
...
| `v0.3.1` | pending | Tool-cache prompt generation, bounded prompt budget, item boundary truncation, sticky session failure |
